...
int	main(void)
{
	...
	print_stack(stack);
	// Test cases
	printf("Position for 9 : %d == 3 \n", ft_get_pos_of(stack, 5, 9));
		// Should find position
	printf("Position for 2: %d == 1\n", ft_get_pos_of(stack, 5, 2));  
		// Should handle number less than all
	printf("Position for 7: %d == 2\n", ft_get_pos_of(stack, 5, 7));  
		// Should handle number greater than all
	printf("Position for 23: %d == 4\n", ft_get_pos_of(stack, 5, 23));
		// Should find position
	printf("Position for 0: %d == 0\n", ft_get_pos_of(stack, 5, 0));  
		// Should find position
	// Clean up
	while (stack)
	{
